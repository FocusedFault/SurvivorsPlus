...
namespace SurvivorsPlus.Mercenary
{
    public class MercenaryChanges
    {
        ...
        {
            SurvivorsPlus.ChangeEntityStateValue("RoR2/Base/Merc/EntityStates.Merc.Evis.asset", "damageCoefficient", "2.6");
            ...
            skillLocator.special.skillFamily.variants[0].skillDef.skillDescriptionToken = "Target the nearest enemy, attacking them for <style=cIsDamage>260% damage</style> repeatedly. <style=cIsUtility>You cannot be hit for the duration</style>.";
        }
    }
}